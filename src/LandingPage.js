...
const STYLES = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav-cta {
    padding: 12px 32px; border-radius: 7px; font-size: 22px; letter-spacing: 1.5px;
    font-family: 'Cinzel', serif; font-weight: 900; cursor: pointer; text-decoration: none;
    background: rgba(201,168,76,0.1); border: 1px solid rgba(201,168,76,0.4); color: var(--gold);
    transition: all 0.2s; animation: ctaGlow 2.5s ease-in-out infinite;
  }
  .nav-cta:hover { background: rgba(201,168,76,0.2); border-color: rgba(201,168,76,0.7); animation: none; box-shadow: 0 0 24px rgba(201,168,76,0.4); }
  @keyframes ctaGlow {
    0%, 100% { box-shadow: 0 0 0px rgba(201,168,76,0); border-color: rgba(201,168,76,0.35); }
    50%       { box-shadow: 0 0 18px rgba(201,168,76,0.45), 0 0 40px rgba(201,168,76,0.15); border-color: rgba(201,168,76,0.75); }
  }
  ...
  .urgency-banner {
    ...
    text-align: center; padding: 10px 24px; font-size: 14px;
  ...
  .hero-badge {
    ...
    font-size: 14px; letter-spacing: 2px; text-transform: uppercase; color: var(--gold);
  ...
  .hero-sub {
    font-size: clamp(17px, 2vw, 20px); color: var(--text-dim); max-width: 580px; margin: 28px auto 0;
  ...
  .section-label::before { content: ''; width: 36px; height: 2px; background: var(--gold); border-radius: 1px; }
  ...
  .terminal-tab {
    padding: 10px 20px; font-size: 15px; font-weight: 600; font-family: 'Inter', sans-serif;
  ...
  .tv-slot-name { font-size: 15px; font-weight: 700; color: var(--text); }
  .tv-slot-badge { font-size: 13px; font-weight: 700; padding: 3px 10px; border-radius: 4px; letter-spacing: 0.5px; }
  ...
  .tv-kv-label { font-size: 12px; color: var(--text-dim); text-transform: uppercase; letter-spacing: 1px; font-weight: 600; }
  .tv-kv-val { font-size: 15px; font-weight: 700; color: var(--text); transition: color 0.3s; }
  .tv-kv-val.green { color: var(--green); }
  .tv-kv-val.red { color: #e74c3c; }
  .tv-kv-val.gold { color: var(--gold); }
  .tv-alert {
    margin: 0 10px 8px; padding: 9px 12px; border-radius: 6px; font-size: 14px; font-weight: 600;
  ...
  .tv-ai-label { font-size: 12px; color: var(--gold); text-transform: uppercase; letter-spacing: 2px; font-weight: 800; margin-bottom: 6px; display: flex; align-items: center; gap: 6px; }
  ...
  .pricing-features li { font-size: 17px; color: #c0d0dc; display: flex; align-items: center; gap: 10px; }
  ...
  /* FOOTER */
  footer {
    padding: 40px 48px; border-top: 1px solid var(--border-solid);
    display: flex; align-items: center; justify-content: space-between;
    font-size: 16px; color: var(--text-dim); background: var(--bg2);
  }
  .footer-logo { font-family: 'Cinzel', serif; color: var(--gold); font-size: 26px; letter-spacing: 2px; font-weight: 900; }
  .footer-links { display: flex; gap: 24px; }
  .footer-link { color: var(--text-dim); text-decoration: none; transition: color 0.2s; font-size: 16px; }
