...
const CHANGELOG = [
  {
    ...
    date: "April 2026",
    items: [
      { type: "new",      text: "Trade Board — post WTS/WTB listings for rare items and trades above max cash. Supports k/m/b price input, expiry countdown, bump to top, and Discord trade channel integration." },
      { type: "new",      text: "Flip exclusion — mark any open position as non-flip (set exchange pieces, personal buys) to keep your GP/hr and win rate accurate. Cannot exclude losing closed flips." },
      { type: "new",      text: "Settings page rebuilt — sidebar navigation with dedicated sections for General, Alerts, RuneLite Plugin, Connections, and Account." },
      { type: "improved", text: "Player card button redesigned — avatar circle, XP progress bar, quest count. Click avatar to open profile menu, click card to open player panel." },
      { type: "improved", text: "Trading Terminal moved to nav row as a persistent button — less intrusive, still glows periodically as a reminder." },
      { type: "improved", text: "Potion decanting items are now clickable — click any input or output dose to open its price chart." },
      { type: "improved", text: "Recipe categories show correct labels — GE Sets listings now display GE Sets instead of Grand Exchange." },
      { type: "fixed",    text: "Player card footer buttons no longer obscured by the AI advisor button." },
    ],
  },
  {
    version: "v1.3",
    date: "April 2026",
    items: [
      { type: "new",      text: "Recipes tab — GE set exchange calculator with live profit, ROI and Vol/Day for ~110 sets. Supports Making and Breaking direction." },
      { type: "new",      text: "Potion decanting — find profitable dose conversions across all major potions via Bob Barter." },
      { type: "new",      text: "New items badge — items added to the GE in the last 30 days show a NEW badge in the market table." },
      { type: "improved", text: "Personalised Picks filters completely reworked — more items surface with relaxed thresholds and clean price banding." },
      { type: "fixed",    text: "Quest emoji rendering fixed sitewide." },
    ],
  },
  {
    version: "v1.2",
    date: "March 2026",
    items: [
      { type: "new",      text: "Sync pause — press Shift+P in the RuneLite plugin to pause GE tracking when buying items for personal use." },
      { type: "new",      text: "Buy limit countdown overlays — plugin shows a live countdown on each slot for when your 4-hour limit resets." },
      { type: "new",      text: "Drift alert overlays — plugin highlights slots where your offer has drifted from market price, with exact relist price on the slot." },
      { type: "new",      text: "Flip recommendation panel — plugin side panel with your personalised top picks in-game, updated every 60s." },
      { type: "improved", text: "Profit calculations now use actual fill price — more accurate GP/hr and ROI." },
      { type: "improved", text: "Picks preferences sync to your account — set them once, the plugin uses them automatically." },
      { type: "fixed",    text: "Login streak no longer breaks at midnight for UTC-5 and other western timezones." },
    ],
  },
  {
    version: "v1.1",
    date: "March 2026",
    items: [
      { type: "new",      text: "Margin Compression Detector — tracks 24hr margin movement, flags crashes, compression and recoveries on every item row." },
      { type: "new",      text: "Session Summary — exiting the Trading Terminal shows GP made, flips closed, GP/hr and best flip." },
      { type: "new",      text: "Beat-the-market relist pricing — relist suggestions price ahead of the queue, not just match it." },
      { type: "improved", text: "Market table no longer flickers during background price updates — rows update in-place." },
    ],
  },
  {
    version: "v1.0",
    ...
    items: [
      ...
      { type: "new", text: "Death's Coffer tool — find the cheapest items to sacrifice with a potential savings calculator." },
      { type: "new", text: "Portfolio page — win rate donut, per-item P&L, best and worst items by period." },
      { type: "new", text: "Trade Board — community WTS/WTB listings for rare items." },
      { type: "new", text: "Quick alert bell — set price alerts directly from any market row." },
    ],
  },
  {
    version: "v0.9",
    date: "February 2026",
    items: [
      { type: "new", text: "Trading Terminal — full trading dashboard with Operations, Analytics, Market and Alerts tabs." },
      ...
      { type: "new", text: "AI Advisor with live slot context and personalised flip recommendations." },
...
const STYLES = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .sync-paused-banner { display: flex; align-items: center; justify-content: space-between; padding: 8px 20px; background: rgba(243,156,18,0.06); border-bottom: 1px solid rgba(243,156,18,0.18); gap: 12px; flex-wrap: wrap; }
  ...
  .left-panel { flex: 1; overflow-y: auto; padding: 20px 24px; display: flex; flex-direction: column; gap: 16px; }
  ...
  .coffer-efficiency-ok { display: inline-flex; align-items: center; justify-content: center; padding: 2px 8px; border-radius: 4px; font-size: 12px; font-weight: 700; background: rgba(243,156,18,0.12); color: #f39c12; }
  ...
  .adv-filter-toggle { display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 13px; color: var(--text-dim); user-select: none; padding: 4px 0; }
  ...
  .flip-row { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 90px 80px; padding: 11px 16px; border-bottom: 1px solid var(--border); transition: background 0.1s, box-shadow 0.1s; cursor: pointer; align-items: center; }
  .flip-row:last-child { border-bottom: none; }
  .flip-row:hover { background: rgba(201,168,76,0.04); box-shadow: inset 3px 0 0 rgba(201,168,76,0.35); }
  ...
  .item-category { font-size: 12px; color: #8899aa; margin-top: 1px; }
  ...
  .roi { font-size: 13px; color: #99aabb; font-variant-numeric: tabular-nums; }
  ...
  .score-low { background: rgba(231,76,60,0.1); color: var(--red); border: 1px solid rgba(231,76,60,0.2); }
  ...
  .smart-alert-toggles { background: #111620; border: 1px solid #1c2a3a; border-radius: 12px; padding: 22px; display: flex; flex-direction: column; gap: 16px; }
  .smart-alert-toggle-title { font-family: "Cinzel", serif; font-size: 14px; font-weight: 700; color: #e8e8e8; text-transform: uppercase; letter-spacing: 2px; }
  .smart-alert-toggle-row { display: flex; align-items: center; justify-content: space-between; padding: 13px 0; border-bottom: 1px solid #0f1820; gap: 16px; }
  .smart-alert-toggle-row:last-child { border-bottom: none; padding-bottom: 0; }
  .smart-alert-toggle-info { display: flex; flex-direction: column; gap: 4px; flex: 1; }
  .smart-alert-toggle-name { font-size: 14px; font-weight: 600; color: #e8e8e8; display: flex; align-items: center; gap: 8px; }
  .smart-alert-toggle-desc { font-size: 13px; color: #8fa0b0; }
  .toggle-switch { position: relative; width: 44px; height: 24px; flex-shrink: 0; cursor: pointer; }
  .toggle-switch input { opacity: 0; width: 0; height: 0; position: absolute; }
  .toggle-slider { position: absolute; cursor: pointer; inset: 0; background: #1a2535; border: 2px solid #344a62; border-radius: 24px; transition: 0.22s; }
  .toggle-slider:before { position: absolute; content: ""; height: 14px; width: 14px; left: 3px; bottom: 3px; background: #6a8099; border-radius: 50%; transition: 0.22s; }
  .toggle-switch input:checked + .toggle-slider { background: rgba(201,168,76,0.18); border-color: rgba(201,168,76,0.6); }
  .toggle-switch input:checked + .toggle-slider:before { transform: translateX(20px); background: #c9a84c; }
  ...
  .smart-event-msg { font-size: 13px; color: var(--text-dim); margin-top: 2px; }
  .smart-event-time { font-size: 12px; color: var(--text-dim); white-space: nowrap; }
  ...
  .alert-form { background: #111620; border: 1px solid #1c2a3a; border-radius: 12px; padding: 22px; display: flex; flex-direction: column; gap: 16px; }
  .alert-form-title { font-family: "Cinzel", serif; font-size: 14px; font-weight: 700; color: #e8e8e8; text-transform: uppercase; letter-spacing: 2px; }
  ...
  .alerts-list { background: #111620; border: 1px solid #1c2a3a; border-radius: 12px; overflow: hidden; }
  .alert-row { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 40px; padding: 13px 16px; border-bottom: 1px solid #0f1820; align-items: center; font-size: 14px; transition: background 0.1s; }
  ...
  .alert-header-row { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 40px; padding: 10px 16px; background: #0c1018; font-size: 11px; color: #6a7d90; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; border-bottom: 1px solid #1c2a3a; }
  .alerts-empty { padding: 60px 20px; text-align: center; color: #6a7d90; }
  .alerts-empty .icon { font-size: 40px; margin-bottom: 12px; opacity: 0.4; }
  .alert-info { background: rgba(52,152,219,0.06); border: 1px solid rgba(52,152,219,0.18); border-radius: 8px; padding: 13px 16px; font-size: 13px; color: #8fa0b0; display: flex; align-items: center; gap: 8px; }
  .notif-banner { display: flex; align-items: center; justify-content: space-between; gap: 16px; background: rgba(201,168,76,0.06); border: 1px solid rgba(201,168,76,0.2); border-radius: 12px; padding: 18px 22px; flex-wrap: wrap; }
  .notif-banner-left { display: flex; align-items: center; gap: 14px; flex: 1; min-width: 0; }
  ...
  .port-stat { background: #111620; border: 1px solid #1c2a3a; border-radius: 12px; padding: 20px 16px; display: flex; flex-direction: column; gap: 5px; transition: border-color 0.2s; }
  .port-stat:hover { border-color: #28394d; }
  .port-stat-label { font-size: 11px; color: #8fa0b0; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 600; }
  .port-stat-value { font-size: 22px; font-weight: 700; font-family: "Cinzel", serif; color: var(--gold); line-height: 1.1; }
  .port-stat-sub { font-size: 13px; color: #8fa0b0; margin-top: 2px; }
  .port-two-col { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
  .port-card { background: #111620; border: 1px solid #1c2a3a; border-radius: 12px; padding: 22px; display: flex; flex-direction: column; gap: 16px; }
  .port-card-title { font-family: "Cinzel", serif; font-size: 12px; font-weight: 700; color: #8fa0b0; text-transform: uppercase; letter-spacing: 2px; }
  .alloc-empty { font-size: 13px; color: #8fa0b0; padding: 16px 0; }
  .alloc-bar-wrap { display: flex; flex-direction: column; gap: 10px; }
  .alloc-bar-row { display: flex; align-items: center; gap: 10px; font-size: 13px; }
  .alloc-bar-label { width: 140px; color: var(--text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; flex-shrink: 0; }
  .alloc-bar-track { flex: 1; height: 7px; background: #0c1018; border-radius: 4px; overflow: hidden; border: 1px solid #1c2a3a; }
  .alloc-bar-fill { height: 100%; border-radius: 4px; background: linear-gradient(90deg, #8a6f2e, #c9a84c); transition: width 0.4s ease; }
  .alloc-bar-val { width: 80px; text-align: right; color: #8fa0b0; flex-shrink: 0; font-size: 13px; }
  .pnl-table { background: #0c1018; border: 1px solid #1c2a3a; border-radius: 8px; overflow: hidden; }
  .pnl-header { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; padding: 9px 14px; background: #111620; font-size: 11px; color: #8fa0b0; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; border-bottom: 1px solid #1c2a3a; }
  .pnl-row { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; padding: 11px 14px; border-bottom: 1px solid #0f1820; font-size: 13px; align-items: center; transition: background 0.1s; }
  .pnl-row:last-child { border-bottom: none; }
  .pnl-row:hover { background: rgba(255,255,255,0.02); }
  .winrate-ring-wrap { display: flex; align-items: center; gap: 24px; }
  .winrate-legend { display: flex; flex-direction: column; gap: 12px; font-size: 13px; }
  .winrate-legend-row { display: flex; align-items: center; gap: 8px; color: #8fa0b0; }
  .winrate-dot { width: 10px; height: 10px; border-radius: 50%; flex-shrink: 0; }
  .bw-table { background: #0c1018; border: 1px solid #1c2a3a; border-radius: 8px; overflow: hidden; }
  .bw-header { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; padding: 9px 14px; background: #111620; font-size: 11px; color: #8fa0b0; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; border-bottom: 1px solid #1c2a3a; }
  .bw-row { display: grid; grid-template-columns: 2fr 1fr 1fr 1fr; padding: 11px 14px; border-bottom: 1px solid #0f1820; font-size: 13px; align-items: center; }
  .bw-row:last-child { border-bottom: none; }
  .bw-row:hover { background: rgba(255,255,255,0.02); }
  .bw-section-label { font-size: 11px; color: #8fa0b0; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 700; padding: 8px 14px; background: rgba(0,0,0,0.2); border-bottom: 1px solid #1c2a3a; }
  ...
  .portfolio-login-prompt { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 16px; padding: 80px 20px; text-align: center; }
  ...
  async function fetchPrices(isManualRefresh = false) {
    ...
    try {
      ...
      for (const [idStr, meta] of Object.entries(mappingMap)) {
        ...
        const flip = { id, name: meta.name, category: meta.members ? "Members" : "F2P", members: !!meta.members, buyLimit: meta.limit || 0, high: high || null, low: low || null, margin, roi, volume, score, lastTradeTime, hasPrice, highalch: meta.highalch || 0, itemValue: meta.value || 0 };
        flips.push(flip);
      }
                  ...
                  {showProfileMenu && (
                    <>
                      ...
                      <div className="profile-dropdown" style={{ zIndex: 149 }} onClick={() => setShowProfileMenu(false)}>
                        <div style={{ padding: "14px 16px 12px", borderBottom: "1px solid var(--border)", background: "rgba(201,168,76,0.03)" }}>
                          <div style={{ fontSize: "15px", fontWeight: 700, color: "var(--text)", display: "flex", alignItems: "center", gap: "8px" }}>
                            {user.user_metadata?.username || user.email?.split("@")[0]}
                            {isSupporter && (
                              <span title="Supporter" style={{ fontSize: "11px", background: "rgba(201,168,76,0.12)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "4px", padding: "2px 6px", color: "#c9a84c", fontWeight: 700, letterSpacing: "0.2px" }}>💎</span>
                            )}
                          </div>
                          <div style={{ fontSize: "13px", color: "var(--text-dim)", marginTop: "4px", fontWeight: 500 }}>
                            {isOnTrial
                              ? <span style={{ color: "#f39c12", fontWeight: 600 }}>⏳ Pro Trial — {trialDaysLeft} day{trialDaysLeft !== 1 ? "s" : ""} left</span>
                              : isPro ? <span style={{ color: "var(--green)", fontWeight: 600 }}>✓ Pro member</span> : <span>Free plan</span>}
                          </div>
                        </div>
